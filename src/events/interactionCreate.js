  ...
  async execute(interaction, client) {
    ...
    try {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(
                'Build your entire welcome message using the controls below.'
            )
            .addFields(
                {
                    name: 'Status',
            ...
            .setFooter({
                text: 'Use the controls below to edit your welcome embed.'
            });
            ...
            new ActionRowBuilder().addComponents(
                new StringSelectMenuBuilder()
                    ...
                    .addOptions(
                        {
                            label: 'Title',
                            description: 'Edit the welcome title',
                            value: 'title',
                            emoji: '📝'
                        },
                        {
                            label: 'Description',
                            description: 'Edit the welcome description',
                            value: 'description',
                            emoji: '📄'
                        },
                        {
                        ...
                        {
                            label: 'Image',
                            description: 'Set the large image',
                            value: 'image',
                            emoji: '🌄'
                        },
                        {
        ...
        logger.info('[WELCOME] Dashboard sent successfully');

        return;

    } catch (error) {
        logger.error('[WELCOME] Dashboard ERROR', {
            error: error.message,
            stack: error.stack
        });
